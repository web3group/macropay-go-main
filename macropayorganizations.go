...
type MacropayOrganizations struct {
	rootSDK          *Macropay
	sdkConfiguration config.SDKConfiguration
	hooks            *hooks.Hooks
}

func newMacropayOrganizations(rootSDK *Macropay, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *MacropayOrganizations {
	return &MacropayOrganizations{
		rootSDK:          rootSDK,
...
func (s *MacropayOrganizations) Get(ctx context.Context, slug string, opts ...operations.Option) (*operations.CustomerPortalOrganizationsGetResponse, error) {
