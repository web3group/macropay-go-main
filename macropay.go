...
var ServerList = map[string]string{
	ServerProduction: "https://api.macropay.sh",
	ServerSandbox:    "https://sandbox-api.macropay.sh",
}
...
type SDKOption func(*Macropay)

// WithServerURL allows providing an alternative server URL
func WithServerURL(serverURL string) SDKOption {
	return func(sdk *Macropay) {
...
func New(opts ...SDKOption) *Macropay {
	sdk := &Macropay{
		SDKVersion: "0.15.0",
		sdkConfiguration: config.SDKConfiguration{
