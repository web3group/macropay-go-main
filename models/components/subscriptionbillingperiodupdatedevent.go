...
// SubscriptionBillingPeriodUpdatedEvent - An event created by Macropay when a subscription billing period is updated.
type SubscriptionBillingPeriodUpdatedEvent struct {
	...
	// ID of the customer in your Macropay organization associated with the event.
	...
	// The source of the event. `system` events are created by Macropay. `user` events are the one you create through our ingestion API.
