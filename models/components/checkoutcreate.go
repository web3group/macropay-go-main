...
type CheckoutCreate struct {
	...
	// ID of the customer in your system. If a matching customer exists on Macropay, the resulting order will be linked to this customer. Otherwise, a new customer will be created with this external ID set.
	...
	// If you plan to embed the checkout session, set this to the Origin of the embedding page. It'll allow the Macropay iframe to communicate with the parent page.
