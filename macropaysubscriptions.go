...
type MacropaySubscriptions struct {
	rootSDK          *Macropay
	sdkConfiguration config.SDKConfiguration
	hooks            *hooks.Hooks
}

func newMacropaySubscriptions(rootSDK *Macropay, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *MacropaySubscriptions {
	return &MacropaySubscriptions{
		rootSDK:          rootSDK,
...
func (s *MacropaySubscriptions) List(ctx context.Context, request operations.CustomerPortalSubscriptionsListRequest, security operations.CustomerPortalSubscriptionsListSecurity, opts ...operations.Option) (*operations.CustomerPortalSubscriptionsListResponse, error) {
...
//
// **Scopes**: `customer_portal:read` `customer_portal:write`
func (s *MacropaySubscriptions) Get(ctx context.Context, security operations.CustomerPortalSubscriptionsGetSecurity, id string, opts ...operations.Option) (*operations.CustomerPortalSubscriptionsGetResponse, error) {
...
func (s *MacropaySubscriptions) Cancel(ctx context.Context, security operations.CustomerPortalSubscriptionsCancelSecurity, id string, opts ...operations.Option) (*operations.CustomerPortalSubscriptionsCancelResponse, error) {
...
func (s *MacropaySubscriptions) Update(ctx context.Context, security operations.CustomerPortalSubscriptionsUpdateSecurity, id string, customerSubscriptionUpdate components.CustomerSubscriptionUpdate, opts ...operations.Option) (*operations.CustomerPortalSubscriptionsUpdateResponse, error) {
